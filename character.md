...
ox華扇 <- ox主人公
紅魔館の住民 : ox美鈴 oパチュリー o咲夜 oレミリア _フラン
地霊殿の住民 : oさとり o燐 o空 _こいし
命蓮寺の住民 : oナズーリン o白蓮 _星 o村紗 o一輪 _響子
xパチュリー <- xレミリア x魔理沙
oパチュリー <- o魔理沙
x咲夜 <- xレミリア
oxレミリア <-> oxフラン
バカルテット : oxルーミア  oxチルノ oxリグル oxミスティア
守矢神社組 : ox早苗 ox神奈子 ox諏訪子
oxレティ <- ox縦横隣接マス
oxプリズムリバー, ox文, oxはたて x_パルスィ<- ox同じマス
oxミスティア <- xo幽々子
oミスティア <- o響子
ox慧音 <-> ox妹紅
ox橙 <- ox藍,ox紫
...
oxにとり <- ox魔理沙
ox 衣玖 <- ox天子
x天子 <- o[美鈴・紫・永琳・小町・早苗・神奈子・勇儀・白蓮]
xマミゾウ, x白蓮 <- o[神子・布都・青娥・芳香]
xマミゾウ <- o藍
x神子 <- o[ナズーリン・白蓮・星・村紗・一輪・響子・マミゾウ・ぬえ]
oxヤマメ <- ox勇儀
oヤマメ <- oパルスィ
ox勇儀 <- ox萃香
o勇儀 <- oヤマメ oパルスィ
